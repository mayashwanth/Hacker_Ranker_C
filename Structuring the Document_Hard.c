...
Help her convert the document to struct document form by completing the following functions:

void initialise_document(chat * text) to intialise the document. You have to intialise the global variable Doc of type struct document.
struct paragraph kth_paragraph(int k,intm) to return the kth paragraph in the document.
